...
<%
    ...
    MessageListView viewData = MessageListView.getMessageList(pageNumber);
...
<html>
	...
	<body>
        <form action ="writeMessage.jsp" mothod ="post">
            이름 : <input type="text" name="guestName"><br>
            암호 : <input type="password" name="password"><br>
            메세지 : <textarea cols="30" rows="3" name="message"></textarea> <br>
